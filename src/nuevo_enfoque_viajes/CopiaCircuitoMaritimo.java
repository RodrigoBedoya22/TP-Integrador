...
public class CopiaCircuitoMaritimo {
	
	ArrayList<CopiaTramo> tramos;
	
    public CopiaCircuitoMaritimo (ArrayList<CopiaTramo> tramos) {
     ...
     */
    public boolean validarListaDeTramos(ArrayList<CopiaTramo> tramos){
    	...
    	ArrayList<CopiaTramo> copia = new ArrayList<>(tramos);
    	CopiaTramo tramoAnterior = copia.get(0);
    	//por cada tramo
    	for (int i = 1; i < copia.size(); i++) {
    		CopiaTramo tramo = copia.get(i);
    	...
    	CopiaTramo ultimo = copia.get(copia.size() - 1);
    ...
    public ArrayList<CopiaTramo> getTramos() {
